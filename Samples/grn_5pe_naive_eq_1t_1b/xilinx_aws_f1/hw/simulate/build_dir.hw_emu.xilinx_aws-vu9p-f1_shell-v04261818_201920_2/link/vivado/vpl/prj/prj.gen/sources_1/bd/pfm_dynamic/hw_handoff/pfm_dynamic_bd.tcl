...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.NUM_TRACE_PORTS {2} \
   CONFIG.SLR_ASSIGNMENTS {SLR0} \
   CONFIG.S_AXIMM_DATA_WIDTH {64} \
 ] $dpa_hub

  # Create instance: dpa_mon0, and set properties
  set dpa_mon0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_aximm_perf_mon:1.0 dpa_mon0 ]
  set_property -dict [ list \
   ...
   CONFIG.MONITOR_ID {grn_5pe_naive_eq_1t_1b_1:m00_axi-DDR[0]} \
   CONFIG.TRACE_READ_ID {0} \
   CONFIG.TRACE_WRITE_ID {1} \
 ] $dpa_mon0
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/grn_5pe_naive_eq_1t_1b_1/m00_axi-DDR[0]} [get_bd_cells /System_DPA/dpa_mon0]
  ...
  connect_bd_intf_net -intf_net dpa_mon0_TRACE_OUT_0 [get_bd_intf_pins dpa_hub/TRACE_IN_0] [get_bd_intf_pins dpa_mon0/TRACE_OUT_0]
  connect_bd_intf_net -intf_net dpa_mon0_TRACE_OUT_1 [get_bd_intf_pins dpa_hub/TRACE_IN_1] [get_bd_intf_pins dpa_mon0/TRACE_OUT_1]
  connect_bd_intf_net -intf_net grn_5pe_naive_eq_1t_1b_1_m00_axi [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon0/MON_M_AXI]
  connect_bd_intf_net -intf_net slr0_M01_AXI [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon0/MON_S_AXI]
  ...
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins mon_clk] [get_bd_pins dpa_ctrl_interconnect/M00_ACLK] [get_bd_pins dpa_ctrl_interconnect/M01_ACLK] [get_bd_pins dpa_hub/axilite_clk] [get_bd_pins dpa_hub/trace_clk] [get_bd_pins dpa_mon0/mon_clk] [get_bd_pins dpa_mon0/trace_clk]
  ...
  connect_bd_net -net slr0_peripheral_aresetn [get_bd_pins mon_resetn] [get_bd_pins dpa_ctrl_interconnect/M00_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M01_ARESETN] [get_bd_pins dpa_hub/axilite_aresetn] [get_bd_pins dpa_hub/trace_aresetn] [get_bd_pins dpa_mon0/mon_resetn] [get_bd_pins dpa_mon0/trace_rst]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: grn_5pe_naive_eq_1t_1b_1, and set properties
  set grn_5pe_naive_eq_1t_1b_1 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:grn_5pe_naive_eq_1t_1b:1.0 grn_5pe_naive_eq_1t_1b_1 ]
  ...
  connect_bd_intf_net -intf_net grn_5pe_naive_eq_1t_1b_1_m00_axi [get_bd_intf_pins grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_intf_pins memory_subsystem/S04_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets grn_5pe_naive_eq_1t_1b_1_m00_axi] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins memory_subsystem/S04_AXI]
  ...
  connect_bd_intf_net -intf_net slr0_M01_AXI [get_bd_intf_pins grn_5pe_naive_eq_1t_1b_1/s_axi_control] [get_bd_intf_pins slr0/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets slr0_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins slr0/M01_AXI]
  ...
  connect_bd_net -net grn_5pe_naive_eq_1t_1b_1_interrupt [get_bd_pins grn_5pe_naive_eq_1t_1b_1/interrupt] [get_bd_pins interrupt_concat/In0]
  connect_bd_net -net irq_cu_1 [get_bd_ports irq_cu] [get_bd_pins interrupt_concat/xlconcat_interrupt_dout]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins System_DPA/mon_clk] [get_bd_pins grn_5pe_naive_eq_1t_1b_1/ap_clk] [get_bd_pins kernel_clk/clk] [get_bd_pins memory_subsystem/aclk1] [get_bd_pins slr0/slowest_sync_clk] [get_bd_pins slr1/slowest_sync_clk] [get_bd_pins slr2/slowest_sync_clk]
  ...
  connect_bd_net -net slr0_peripheral_aresetn [get_bd_pins System_DPA/mon_resetn] [get_bd_pins grn_5pe_naive_eq_1t_1b_1/ap_rst_n] [get_bd_pins slr0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_addr_segs memory_subsystem/S04_AXI/M00_AXI_MEM00] -force
  ...
  assign_bd_address -offset 0x1C020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs grn_5pe_naive_eq_1t_1b_1/s_axi_control/reg0] -force
  ...
  exclude_bd_addr_seg -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_addr_segs memory_subsystem/S04_AXI/M01_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_addr_segs memory_subsystem/S04_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_addr_segs memory_subsystem/S04_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces grn_5pe_naive_eq_1t_1b_1/m00_axi] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM02]
