...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_S04_AXI_HAS_BRESP {false} \
   CONFIG.C_S04_AXI_HAS_BURST {false} \
   CONFIG.C_S04_AXI_HAS_CACHE {false} \
   CONFIG.C_S04_AXI_HAS_LOCK {false} \
   CONFIG.C_S04_AXI_HAS_PROT {false} \
   CONFIG.C_S04_AXI_HAS_QOS {false} \
   CONFIG.C_S04_AXI_HAS_REGION {false} \
   CONFIG.C_S04_AXI_HAS_RRESP {false} \
