...
(
  ...
  assign config_rom[1] = 32'h7;
  assign config_rom[2] = 32'h8;
  assign config_rom[3] = 32'hf;
  assign config_rom[4] = 32'h10;
  assign config_rom[5] = 32'h17;
  assign config_rom[6] = 32'h18;
  assign config_rom[7] = 32'h1f;
...
(
  ...
  wire [4-1:0] grn_pe_config_output_done;
  wire [4-1:0] grn_pe_config_output_valid;
  wire [32-1:0] grn_pe_config_output [0:4-1];
  wire [4-1:0] grn_pe_output_read_enable;
  wire [4-1:0] grn_pe_output_valid;
  wire [32-1:0] grn_pe_output_data [0:4-1];
  wire [4-1:0] grn_pe_output_available;
  ...
  assign grn_pe_output_valid[3] = 0;
  assign grn_pe_output_data[3] = 0;
  assign grn_pe_output_available[3] = 0;
